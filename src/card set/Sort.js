...
export default function Sort({ sorts, setSort }) {
  ...
  return (
    <div className="flex items-center">
      <div className="text-white mr-4 text-lg">Sort By</div>
      <div className="relative cursor-pointer select-none">
        <div className="px-4 py-2 text-white bg-[#4B4B4B] rounded-md font-medium text-lg flex items-center justify-between" onClick={() => setOpen(!open)}>
